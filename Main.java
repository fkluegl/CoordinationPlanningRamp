...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        s_init.addVehicle(v1, true);
        s_init.addVehicle(v2, true);
        ParkingPlace p1 = new ParkingPlace("P1"); p1.setY_position(State.y_max / 10 * 6);
        ParkingPlace p2 = new ParkingPlace("P2"); p2.setY_position(State.y_max / 10 * 7);
        ParkingPlace p3 = new ParkingPlace("P3"); p3.setY_position(State.y_max / 10 * 8);
        ParkingPlace p4 = new ParkingPlace("P4"); p4.setY_position(State.y_max / 10 * 9);
        s_init.addParkingPlace(p1);
        s_init.addParkingPlace(p2);
        s_init.addParkingPlace(p3);
